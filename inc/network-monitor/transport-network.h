...
namespace NetworkMonitor
{
     ...
     * - `id` s unique across all lines and their routes in the network.
    ...
    {
        public:
            /*! \brief Passenger event: Entering or exiting a station
             */
             ...
             *
             * \returns false if the station is not in the network of if the passenger
             ...
             *
             * \returns An empty vector if there was an error getting the list of routes
             *          serving the station, or if the station has legitimately 
             ...
             *          two stations, of if station A and B are the same station.
             * 
             * The travel time is the same for all routes connecting the two stations
             * directly.
             * 
